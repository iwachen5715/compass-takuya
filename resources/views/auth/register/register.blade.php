...
<div class="mt-3 register_form">
  <div class="d-flex" style="justify-content:space-between">
    ...
    <div class="" style="width:140px">
      ...
      @endif
      <label class="d-block m-0" style="font-size:12px">名</label>
      <div class="border-bottom border-primary" style="width:140px;">
  ...
  <div class="d-flex mt-3" style="justify-content:space-between">
    <div class="" style="width:140px">
      ...
      @endif
      <label class="d-block m-0" style="font-size:12px">セイ</label>
      <div class="border-bottom border-primary" style="width:140px;">
    ...
    <div class="" style="width:140px">
      ...
      @endif
      <label class="d-block m-0" style="font-size:12px">メイ</label>
      <div class="border-bottom border-primary" style="width:140px;">
  ...
  <div class="mt-3">
    ...
    @endif
    <label class="m-0 d-block" style="font-size:12px">メールアドレス</label>
...
<div class="mt-3">
  @if ($errors->has('sex'))
    <div class="text-danger text-Item" style="font-size:12px display:flex;  flex: 1; ">{{ $errors->first('sex') }}</div>
  @endif
...
<div class="mt-3">
  ...
  @endif
  <label class="d-block m-0 aa" style="font-size:12px">生年月日</label>
...
<div class="mt-3">
  @if ($errors->has('role'))
    <div class="text-danger" style="font-size:12px; margin-top: 5px; margin-bottom: 5px;">{{ $errors->first('role') }}</div>
  @endif
  <label class="d-block m-0" style="font-size:12px">役職</label>
...
<div class="mt-3">
  ...
  @endif
  <label class="d-block m-0" style="font-size:12px">パスワード</label>
  <div class="border-bottom border-primary">
...
<div class="mt-3">
  ...
  @endif
  <label class="d-block m-0" style="font-size:12px">確認用パスワード</label>
  <div class="border-bottom border-primary">

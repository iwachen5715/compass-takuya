...
@section('content')
<div class="vh-100 border top-border">
  <div class="top_area w-75 pt-5 position-relative">
    <!-- プロフィールの位置を左上に調整 -->
    <p class="top-Icon position-absolute" style="top: 0; left: 0; margin: 0;">
      自分のプロフィール
    </p>

    <div class="w-100 user_status p-3 mt-5">
